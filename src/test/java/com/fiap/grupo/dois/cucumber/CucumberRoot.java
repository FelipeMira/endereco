...
import com.fiap.grupo.dois.EnderecoApplication;

@SpringBootTest(classes = EnderecoApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@ActiveProfiles("test")
